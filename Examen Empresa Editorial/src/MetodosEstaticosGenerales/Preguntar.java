package MetodosEstaticosGenerales;
...
public class Preguntar {
	 ...
	 */
	public static String cadena(String pregunta, int tamaño_min, int tamaño_max, boolean espacios) {
		...
		do {
			...
			else if (cadena_elegida.length()<tamaño_min)
				System.out.println("El valor introducido no puede tener menos de " + tamaño_min + " caracteres. Introduce de nuevo otro valor.");
	...
	public static String cadena(String pregunta, int tamaño_max) {
		return cadena(pregunta, 1, tamaño_max, true);
	}
	...
	public static String cadena(String pregunta) {
		return cadena(pregunta, 1, 50, true);
	}
