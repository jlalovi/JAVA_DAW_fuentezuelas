...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("PROGRAMA QUE DECODIFICA UN TEXTO CON EL MÉTODO CÉSAR");

	 // DELARACIÓN DE VARIABLES
	 // =======================

		String texto;		        // Texto introducido por el usuario y guardado en una cadena (codificado en código César).
		String texto_decodificado;  // Texto codificado con el código César.
	 ...
	 // ========================
		...
		texto_decodificado = "";    // Inicializo 'texto_decodificado' con un valor vacío.
	 ...
	 // ======================
		...
		for (i=0; i<npalabras; i++) { // Este bucle iterará por cada palabra.
			...
			if (i!=npalabras-1)
				texto_decodificado += " ";  // Por cada palabra, añado un espacio (salvo la última palabra).
		}
